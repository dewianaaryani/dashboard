...
import dw from '@/public/images/dw.jpg'
    ...
    <div className='grid lg:grid-cols-3 gap-4'>
        ...
        <Card>
            ...
            <CardFooter>
                {employeesPresentPercentage > 75 ?  (
                    <span className='text-xs text-green-500 flex gap-1 items-center'><BadgeCheckIcon /> {employeesPresentPercentage}% of employees are present</span>
                ): (
                    <span className='text-xs text-red-500 flex gap-1 items-center'><AlertTriangleIcon />Only {employeesPresentPercentage}% of employees are present</span>
                )}
            </CardFooter>
        </Card>
        <Card className='border-pink-500 flex flex-col'>
            ...
            <CardContent className='flex gap-2 items-center'>
                <Avatar>
                    <Image src={dw} alt="employee of the month" />
                    <AvatarFallback>DA</AvatarFallback>
                </Avatar>
                <span className='text-2xl'>Dewiana Aryani!</span>
            </CardContent>
            <CardFooter className='flex gap-2 items-center text-xs text-muted-foreground mt-auto'>
                <PartyPopperIcon className='text-pink-500' />
                <span>Congratulations, Dewiana!</span>
            </CardFooter>
        </Card>
    </div>
    <Card className='my-4'>
